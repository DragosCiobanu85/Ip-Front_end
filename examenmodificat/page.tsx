...
export default function ModificareExamen() {
  ...
  const [grupe, setGrupe] = useState<Array<{id_Grupa: number; nume: string}>>([]); // Initializing as an empty array
  ...
  useEffect(() => {
    ...
    fetchData();
    console.log("Facultatea", faculty);
    if (faculty) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative">
            <input
              type="text"
              value={
                faculty ? facultati.find((item) => item.id_Facultate === faculty)?.nume || "" : ""
              }
              readOnly
          ...
          <div className="relative">
            <input
              ...
              value={
                specializare
                  ? specializari.find((item) => item.id_Specializare === specializare)?.nume || ""
                  : ""
              }
              readOnly
              className="w-80 px-4 py-2 bg-white border border-slate-800 rounded shadow ml-60 cursor-not-allowed hover:bg-gray-100"
          ...
          <div className="relative">
            <input
              type="text"
              value={grupa ? grupe.find((item) => item.id_Grupa === grupa)?.nume || "" : ""}
              readOnly
              className="w-80 px-4 py-2 bg-white border border-slate-800 rounded shadow ml-60 cursor-not-allowed hover:bg-gray-100"
          ...
          <div className="relative">
            <input
              ...
              value={
                professor !== null
                  ? profesori.find((item) => item.id_Profesor === Number(professor))?.nume ||
                    "Profesor Inexistent"
                  : ""
              }
              readOnly
          ...
          <div className="relative">
            <input
              type="text"
              value={subject ? materii.find((item) => item.id_Materie === subject)?.nume || "" : ""}
              readOnly
              className="w-80 px-4 py-2 bg-white border border-slate-800 rounded shadow ml-60 cursor-not-allowed hover:bg-gray-100"
