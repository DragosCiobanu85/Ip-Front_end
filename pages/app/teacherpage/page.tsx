// acest cod este pentru Desktop 5 din figma
"use client";
...
export default function TeacherAccount() {
  ...
  return (
    <>
      <Link href={`/setexams`} style={{textDecoration: "none"}}>
        <Button
          variant="outlined"
          type="submit"
          style={{
            ...
            {rows.map((row) => (
              <StyledTableRow key={row.id}>
                ...
                <StyledTableCell
                  ...
                  <Link href={`/examenprofesor`} passHref>
                    <Button variant="outlined" size="small">
                      Modifică
                    </Button>
                  </Link>
                  <Link href={`/accepta/${row.id}`} passHref>
                    <Button variant="outlined" size="small">
                      Acceptă
                    </Button>
                  </Link>

                  <Button variant="outlined" onClick={() => handleCancel(row.id)} size="small">
                    Anulează
                  </Button>
                </StyledTableCell>
              </StyledTableRow>
